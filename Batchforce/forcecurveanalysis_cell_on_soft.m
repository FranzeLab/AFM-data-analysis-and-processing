function [Results] = forcecurveanalysis_cell_on_soft (rawdata,headerinfo,userInput,minCP_index,w,local_CP_index,Esubst)
%% Modified version of fca to account for soft substrate of known modulus %%
...
indentationdata(:,1) = (-1)*indentationdata(:,1);
 %% begin insert for correction for soft substrate
c = 9 / (4 * pi * local_beadradius * Esubst);
