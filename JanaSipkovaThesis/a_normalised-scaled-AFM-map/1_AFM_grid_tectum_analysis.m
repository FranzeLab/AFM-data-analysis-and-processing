%% 1_AFM_grid_tectum_analysis.m          by Jana Sipkova, 22/05/2022
...
PathName = uigetdir('/Volumes/Jana_Lab/PhD Data/AFM_new/Analysed/unlabelled/tectum_mapping/', "Choose the folder");
...
%norm_AFMgrid = mat2gray(AFMgrid_final); % does all together, not x and y separately
...
%SavingDir = uigetdir('/Users/janasipkova/Dropbox (Cambridge University)/Franze lab/Data/AFM/tectum_mapping/', "Choose the folder");
SavingDir = PathName;
