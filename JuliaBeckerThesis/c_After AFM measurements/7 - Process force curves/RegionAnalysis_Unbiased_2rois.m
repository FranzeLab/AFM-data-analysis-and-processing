...
figurewithlayers_name = fullfile(source(1:end-9),'annotated layers_2_areas.tif');
...
outline_2 = annotations{2,1};
save(source, 'outline_2', '-append')
...
figurewithlayers_name = fullfile(source(1:end-9), 'annotated layers_2_points.tif');
saveas(gcf,figurewithlayers_name);
