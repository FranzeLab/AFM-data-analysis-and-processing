function [rawdata, headerinfo] = readnewforcecurve (filename) 
...
forceBaseline = textscan (forcefile,'# forceBaseline: %f',1);
forceBaselineMeasured = textscan (forcefile,'# forceBaselineMeasured: %s',1);
forceRelativeSetpoint = textscan (forcefile,'# forceRelativeSetpoint: %f',1);
...
headerinfo = {'xposition',xposition;...
    ...
    'forceBaselineMeasured',forceBaselineMeasured;...
    'forceRelativeSetpoint',forceRelativeSetpoint;...
    'setpoint',setpoint;...
    'kLength',kLength;...
